...
\begin{frame}{\text{\tb usepackage\{cleveref\}}}
...
\begin{frame}[fragile]{\text{\tb usepackage\{cleveref\}}}
  \begin{lstlisting}
...
\begin{frame}{\text{\tb usepackage\{hyperref\}}}
  \begin{itemize}
...
\begin{frame}{\text{\tb usepackage\{booktabs\}}}
...
\begin{frame}[fragile]{\text{\tb usepackage\{booktabs\}}}
  \begin{lstlisting}
\begin{tabular}{|l|l|r|}
 \hline
 \multicolumn{2}{|c|}{Item} & \\\cline{1-2}
...
\begin{frame}[fragile]{\text{\tb usepackage\{pgfplotstable\}}}
...
\begin{frame}{\text{\tb usepackage\{pgfplotstable\}}}
  \begin{table}
