...
\begin{frame}{A little about you\ldots}
  \begin{itemize}
	  \item This course is intended for those who already have some \LaTeX{} 
		  experience
  	\item If you want to brush up on the basics then SAgE offer an
      introduction to \LaTeX{} workshop (not taught by me)
  \end{itemize}
\end{frame}
...
\begin{frame}{The game plan}
  \begin{itemize}
  	...
  	\item I am more than happy informing Angela of any skivers (so don't
		  skive)
